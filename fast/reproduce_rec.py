...
CW, CH = 1400, 700                    # canvas; reference is cropped/fit to this aspect
tab = None
...
def build_strokes(im):
    ...
    passes = [(44, 10, 1.4, 0), (24, 6, 1.5, 0), (13, 4, 1.6, 0), (7, 2, 1.6, 4), (4, 1, 1.7, 12), (2, 1, 1.8, 28)]
...
async def main():
    ...
    # concurrent timelapse grabber
    FR = "rframes"; os.makedirs(FR, exist_ok=True)
    ...
    stop.set(); nfr = await grabber
    print(f"painted {len(strokes)} strokes in {dt:.1f}s, {nfr} frames", flush=True)
    await tab.png("repro_hi.png")
