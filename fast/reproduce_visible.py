...
async def main():
    ...
    proc = launch_brave(9231, size=(1500, 900))
    ...
    await tab.png("repro_visible.png")
    print("left MattPaint open on screen", flush=True)
    await br.close()   # keep the Brave window; just drop our control socket
asyncio.run(main())
